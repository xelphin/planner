...
$(GRAPHIC_CONTROLS).o: $(GRAPHIC_CONTROLS).cpp $(GRAPHIC_CONTROLS).h $(GRAPHIC_PRINTS).h  $(CALENDAR).h
	$(COMPILER) $(FLAGS) $(G_FLAG) -c $(GRAPHIC_CONTROLS).cpp -o $(GRAPHIC_CONTROLS).o

$(TESTS).o: $(TESTS).cpp $(TESTS).h  $(ALL_DATE) $(ALL_BANNERS) $(ALL_POINTS) $(BANNER).h $(CALENDAR).h $(GRAPHIC_PRINTS).h $(GRAPHIC_CONTROLS).h  $(EXCEPTION).h $(UTILTITIES).h
