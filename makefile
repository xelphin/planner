...
OBJ_FILES = $(ALL_DATE_OBJ) $(ALL_POINTS_OBJ) $(ALL_BANNER_OBJ) $(CALENDAR).o $(UTILTITIES).o $(GRAPHIC_PRINTS).o $(GRAPHIC_BANNER_CREATOR).o $(GRAPHIC_CONTROLS).o $(TESTS).o $(MAIN).o 
...
$(MAIN).o: $(MAIN).cpp  $(ALL_DATE) $(ALL_POINTS) $(ALL_BANNERS) $(CALENDAR).h $(EXCEPTION).h $(UTILTITIES).h $(GRAPHIC_PRINTS).h $(GRAPHIC_BANNER_CREATOR).h $(GRAPHIC_CONTROLS).h $(TESTS).h
...
$(TESTS).o: $(TESTS).cpp $(TESTS).h  $(ALL_DATE) $(ALL_BANNERS) $(ALL_POINTS) $(BANNER).h $(CALENDAR).h $(GRAPHIC_PRINTS).h $(GRAPHIC_BANNER_CREATOR).h  $(GRAPHIC_CONTROLS).h  $(EXCEPTION).h $(UTILTITIES).h
